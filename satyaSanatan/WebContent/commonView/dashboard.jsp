    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html"><img src="img/adi-shankara-logo.png" alt="Logo"></a>
                <a class="navbar-brand hidden" href="index.html"><img src="img/satya-sanatan-logo.png" alt="Logo"></a>
            </div>
